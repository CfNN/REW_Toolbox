function [subjectNumber, sessionNumber, subjectHandedness, cancelled] = GetSessionConfig(settings) 
...
% experimenter.
%
% Usage: [subjectNumber, sessionNumber, subjectHandedness, cancelled] = GetSessionConfig(settings);
